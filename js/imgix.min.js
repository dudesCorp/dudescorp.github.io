...
(function() {
    function a() {
        Object.freeze || (Object.freeze = function(a) {
            ...
            }(window.console || {}), Function.prototype.bind || (Function.prototype.bind = function(a) {
    ...
    d.helpers = {
        ...
        getZoom: function() {
            var a, b = "http://www.w3.org/2000/svg",
                c = 1;
            return document.createElementNS && (a = document.createElementNS(b, "svg"), a.setAttribute("xmlns", b), a.setAttribute("version", "1.1"), document.body.appendChild(a), c = a.currentScale || 1, document.body.removeChild(a)), c
        },
        getDPR: function() {
        ...
        return c !== b ? c ? (a.style.cssText = a.style.cssText.replace(c, b), !0) : (document.addEventListener ? a.style.backgroundImage = "url(" + b + ")" : a.style.cssText = "background-image:url(" + b + ")", !0) : !1
        ...
        var c = 0,
            d = 0,
            e = 0;
        return 3 === a.length ? (c = parseInt(b(a.slice(0, 1)), 16), d = parseInt(b(a.slice(1, 2)), 16), e = parseInt(b(a.slice(2, 3)), 16)) : 6 === a.length ? (c = parseInt(a.slice(0, 2), 16), d = parseInt(a.slice(2, 4), 16), e = parseInt(a.slice(4, 6), 16)) : console.warn("invalid hex color:", a), "rgb(" + c + ", " + d + ", " + e + ")"
        ...
        for (var a = document.getElementsByTagName("*"), b = 0, c = a.length; c > b; b++) d.hasImage(a[b]) && d.setImgixClass(a[b])
        ...
        return d.hasClass(a, e) ? a.className.match(/imgix-el-[^\s]+/)[0] : void 0
        ...
        this.getColors(16, function(e) {
            if (e && e.length < 9) return console.warn("not enough colors to create a gradient"), void(c && "function" == typeof c && c(!1));
            if ("string" == typeof a) {
    ...
    d.URL.prototype.getColors = function(a, b) {
        ...
        var i = function() {
            if (d.findInjectedStyleSheet(h)) {
                var c = null;
                setTimeout(function() {
                    for (var g = [], i = 100, j = 1; a >= j; j++) ! function(a) {
                        var b = document.createElement("span");
                        b.id = e + "-" + a, b.className = e + "-fg-" + a, document.body.appendChild(b), g.push(new Promise(function(e, f) {
                            var g, h = 0;
                            g = function() {
                                var f = d.getCssPropertyById(b.id, "color");
                                f !== c ? (document.body.removeChild(b), e({
                                    num: a,
                                    color: f
                                }), c = f) : ++h < i ? setTimeout(g, 50) : (document.body.removeChild(b), e({
                                    num: a,
                    ...
                    Promise.all(g).then(function(a) {
                        ...
                        c && c.length > 1 && d.getColorBrightness(c[c.length - 1]) < d.getColorBrightness(c[0]) && c.reverse(), f[h] = c, b && b(c)
                    })
                }, 10)
        ...
        function c(a) {
            var c = d.getElementImage(a),
                f = c;
            c && -1 !== c.indexOf("?") && (f = c.split("?")[0]), e.getBaseUrl() ? b(a, e.getUrl()) : f && e.getQueryString() ? b(a, f + "?" + e.getQueryString()) : g++
        }
        var e = this,
            f = 0,
            g = 0,
        ...
        if (d.instanceOfImgixURL(a)) return void console.warn("setParams warning: dictionary of imgix params expectd. imgix URL instance passed instead");
        for (var c in a) a.hasOwnProperty(c) && this.setParam(c, a[c], b, !0);
        this._handleAutoUpdate()
    }, d.URL.prototype.setParam = function(a, b, c, e) {
        if (a = a.toLowerCase(), c = d.isDef(c) ? c : !0, e = d.isDef(e) ? e : !1, ("col" === a || "colorize" === a || "blend" === a || "mono" === a || "monochrome" === a) && "rgb" === b.slice(0, 3) && (b = d.rgbToHex(b)), -1 === d.getAllParams().indexOf(a)) return console.warn("'" + a + "' is an invalid imgix param"), this;
        if (!c && this.urlParts.paramValues[a]) return this;
        if ("txtfont" === a && d.isFontAvailable(b)) {
            var f = d.getFontLookup()[b];
            f && (b = f)
        }
        return d.getDefaultParamValue(a) !== b && d.isDef(b) && null !== b && 0 !== b.length ? (-1 === this.urlParts.params.indexOf(a) && this.urlParts.params.push(a), decodeURIComponent(b) === b && (b = encodeURIComponent(b)), this.urlParts.paramValues[a] = String(b), e || this._handleAutoUpdate(), this) : (this.removeParam(a), this)
        ...
        var a = this.getUrl();
        return -1 !== a.indexOf("?") && (a = this.getUrl().split("?")[0]), a !== window.location.href ? a : ""
    ...
    for (var g in d.URL.theGetSetFuncs) d.URL.theGetSetFuncs.hasOwnProperty(g) && ! function(a) {
    ...
    d.parseUrl = function(a) {
        ...
        if (e.paramValues = {}, e.params = [], e.baseUrl = a.split("?")[0], g && g.length > 0) {
            ...
            for (var h = g.split("&"), i = 0; i < h.length; i++) {
                var j = h[i].split("=");
                j[0] && j[0].length && "s" !== j[0] && (e.paramValues[j[0]] = 2 === j.length ? j[1] : "", -1 === e.params.indexOf(j[0]) && e.params.push(j[0]))
            }
        }
        return e
        ...
        if (a.params.length > 0) {
            ...
            for (var c = [], d = 0; d < a.params.length; d++) a.paramValues[a.params[d]].length > 0 && c.push(a.params[d] + "=" + a.paramValues[a.params[d]]); - 1 !== b.indexOf("?") && (b = b.split("?")[0]), b += "?" + c.join("&")
        }
        return b
    ...
    d.FluidSet = function(a) {
                ...
                if (h.top > i.bottom || h.left > i.right || h.top + g < i.top || h.left + f < i.left) {
                    if (!a.fluidLazyColored && this.options.lazyLoadColor) {
                        ...
                        l.getColors(16, function(b) {
                            if (!b) return void console.warn("No colors found for", l.getURL(), "for element", a);
                            var c = null;
        ...
        if (a) {
            ...
            i.setHeight(""), i.setWidth(""), g = Math.min(g, this.options.maxWidth), h = Math.min(h, this.options.maxHeight), 1 === c || this.options.ignoreDPR || i.setDPR(c), this.options.highDPRAutoScaleQuality && c > 1 && i.setQuality(Math.min(Math.max(parseInt(100 / c, 10), 30), 75)), this.options.fitImgTagToContainerHeight && this.options.fitImgTagToContainerWidth && i.setFit("crop"), "crop" === i.getFit() ? (h > 0 && (!d.isImageElement(a) || d.isImageElement(a) && this.options.fitImgTagToContainerHeight) && i.setHeight(h), g > 0 && (!d.isImageElement(a) || d.isImageElement(a) && this.options.fitImgTagToContainerWidth) && i.setWidth(g)) : g >= h ? i.setWidth(g) : i.setHeight(h), !d.isImageElement(a) && this.options.autoInsertCSSBestPractices && a.style && (a.style.backgroundRepeat = "no-repeat", a.style.backgroundSize = "cover", a.style.backgroundPosition = "50% 50%");
            var j = {};
            null !== this.options.onChangeParamOverride && "function" == typeof this.options.onChangeParamOverride && (j = this.options.onChangeParamOverride(g, h, i.getParams(), a));
    ...
    d.FluidSet.prototype.attachScrollListener = function() {
        i[this.namespace] = d.helpers.throttler(function() {
            this.reload()
        }.bind(this), this.options.throttle), document.addEventListener ? window.addEventListener("scroll", i[this.namespace], !1) : window.attachEvent("onscroll", i[this.namespace]), this.windowScrollEventBound = !0
    }, d.FluidSet.prototype.attachWindowResizer = function() {
        j[this.namespace] = d.helpers.debouncer(function() {
            (this.windowLastWidth !== d.helpers.getWindowWidth() || this.windowLastHeight !== d.helpers.getWindowHeight()) && this.reload()
        }.bind(this), this.options.debounce), window.addEventListener ? window.addEventListener("resize", j[this.namespace], !1) : window.attachEvent && window.attachEvent("onresize", j[this.namespace]), this.windowResizeEventBound = !0
    }, d.fluid = function() {
        var a, c;
        if (arguments.length > 0 && 1 === arguments[0].nodeType ? (c = arguments[0], a = arguments[1]) : a = arguments[0], null !== a) {
            ...
            if (d.helpers.isReallyObject(a)) {
                for (var g = Object.keys(a), h = Object.keys(b()), i = 0; i < g.length; i++) - 1 === h.indexOf(g[i]) && console.warn("'" + g[i] + "' is not a valid imgix.fluid config option. See https://github.com/imgix/imgix.js/blob/master/docs/api.md#imgix.fluid for a list of valid options.");
